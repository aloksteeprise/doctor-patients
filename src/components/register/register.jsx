            ...
            <div className='row'>
                    ...
                    <div className='col-sm-12 row border-bottom border-secondary-subtle'>
                        ...
                        <div className='col-8 col-sm-8'>
                            <p className='text-end'>
                                Are you a doctor? <a href='/doct' style={{ textDecoration: "none" }}><span className='text-warning'>Register Here</span></a>
                            </p>
                        </div>
                    </div>
              ...
              <input class="form-control email-text " id="mobile" name="mobile" placeholder="Mobile Number" type="tel" value=""/>
                    ...
                    <div className='col-sm-12 row' >
                        ...
                        <div className='col-5 col-sm-5 text-center' > <a href='forgot' style={{ textDecoration: "none" }}>
